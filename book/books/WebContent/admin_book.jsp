...
ArrayList<TypeBean> data = (ArrayList<TypeBean>)typedao.get_ListInfo();
  ...
  %>                 <option value="<%= bean.getName() %>"><%= bean.getName() %></option>                        <%} %>                                        
										...
										<div class="form-group">	
											<label for="firstname" class="col-sm-3 control-label">在馆量</label>
												<div class="col-sm-7">
													<input type="text" class="form-control" id="updateInNum" name="innum"  placeholder="请输入在馆量">
												<label class="control-label" for="updateInNum" style="display: none;"></label>
												</div>
										</div>	
										<div class="form-group">	
											<label for="firstname" class="col-sm-3 control-label">外借量</label>
												<div class="col-sm-7">
													<input type="text" class="form-control" id="updateOutNum" name="outnum"  placeholder="请输入外借量">
												<label class="control-label" for="updateOutNum style="display: none;"></label>
												</div>
										</div>	
